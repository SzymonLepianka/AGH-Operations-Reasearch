...
class Network:
    ...
    @staticmethod
    def set_attribute(graph: nx.DiGraph, edge_start: int, edge_end: int, name: str, value: Any) -> int:
        nx.set_edge_attributes(graph, {(edge_start, edge_end): {name: value}})

    @staticmethod
    def get_attribute(graph: nx.DiGraph, edge_start: int, edge_end: int, name: str) -> int:
        return graph.get_edge_data(edge_start, edge_end)[name]
    ...
    def set_capacity(graph: nx.DiGraph, edge_start: int, edge_end: int, capacity: int) -> None:
        nx.set_edge_attributes(
            graph, {(edge_start, edge_end): {'capacity': capacity}})
    ...
    def from_file(path: str) -> Network:
        ...
        nx.set_node_attributes(
            digraph, {source_node: {'color': 'red'}, sink_node: {'color': 'blue'}})
